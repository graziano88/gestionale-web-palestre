<div class="modal-dialog">
	...
	<div class="modal-content">
		...
		<div class="modal-body text-center">
			<p>Vuoi davvero eliminare dal sistema il recapito "<strong><?=$numero?> (<?=$tipologia_str?>)</strong>" dell'utente <strong><?=$username?></strong>?</p>
...
<script>
	var url_delete = '<?=base_url()?>utenteController/deleteRecapitoUtente';
	var id = '<?=$id?>';
