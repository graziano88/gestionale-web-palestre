					...
					<div class="row">
						...
						<div class="col-lg-8">
							<form role="form" action="" method="post" id="sgp-edit-form">
								<input name="id" value="<?=$soglia->id?>" hidden="true">
								<div class="form-group">
									<label>I Alert dopo:</label>
									<div class='input-group'>
										<input class="form-control" type="number" name="giorni_primo_alert" value="<?=$soglia->giorni_primo_alert?>" autofocus>
								...
								<div class="form-group">
									...
									<div class='input-group'>
										<input class="form-control" type="number" name="giorni_secondo_alert" value="<?=$soglia->giorni_secondo_alert?>">
										<span class="input-group-addon">
											<span class="">Giorni</span>
										</span>
									</div>
								...
								<div class="sgp-error-msg" id="sgp-scadenza-errata" style="display: none">
									La scadenza deve essere pari o maggiore alla somma dei giorni dei due alert (Somma: <span></span>)
								</div>
								<div class="form-group">
									<label>Scadenza dopo:</label>
									<div class='input-group'>
										<input class="form-control" type="number" name="scadenza" value="<?=$soglia->scadenza?>">
										<span class="input-group-addon">
											<span class="">Giorni</span>
										</span>
									</div>
...
<script>
	var url_submit_form_function = '<?=base_url()?>gestionevariabili/editSogliaMissedDesk';
