<div id="page-wrapper">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Inserimento nuova telefonata</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-7">
			<form role="form" action="" method="post" id="sgp-insert-form">
				...
				<div class="form-group">
					<label>Motivo Telefonata</label>
					<textarea class="form-control" rows="3" style="margin: 0px -2px 0px 0px; width: 100%; height: 100px;resize: none;" name="motivo" ></textarea>
				</div>
				...
				<div class="form-group">
					...
					<div class="radio">
						<label>
							<input type="radio" name="esito" value="1" checked>Positivo
						</label>
					</div>	
					<div class="radio">
						<label>
							<input type="radio" name="esito" value="0" >Negativo
						</label>
					</div>														
				</div>
...
<script>
	...
	var url_insert_function = '<?=base_url()?>contatticontroller/creaTelefonata';
