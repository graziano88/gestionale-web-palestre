	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<form role="form" action="<?=base_url()?>rinnoviiscrizionicontroller/creaRinnovoIscrizione" method="post" id="sgp-insert-form">
				...
				<input name="id_socio_registrato" value="" hidden="true">
				<input name="id_concatenazione" value="" hidden="true">
				<input name="id_rinnovo_iscrizione_passata" value="" hidden="true">
				<input name="scaduto" value="0" hidden="true">
				
				<div class="form-group">
					<label>Cellulare</label>
					<input class="form-control" name="cellulare">
				</div>
				<div class="form-group">
								...
								<div id="sgp-abbonamento-field">
									<div class="form-group">
										...
										<select class="form-control" name="id_tipo_abbonamento">
											<?=$option_tipi_abbonamento?> <!-- SI AGGIORNA SE FREE PASS == 1 -->
										</select>
									</div>
									<div class="form-group">
				...
				<div class="form-group" id="sgp-missed-field">
					...
					<div class="radio">
						<label>
							<input type="radio" name="missed" value="1" checked>Sì
						</label>
					</div>
					<div class="radio">
						<label>
							<input type="radio" name="missed" value="0" >No
						</label>
					</div>															
				</div>
				<script>
				...
				<div class="form-group">
					<label>Note</label>
					<textarea class="form-control" name="note" rows="5" style="resize: none"></textarea>
				</div>
