<div class="modal-dialog">
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title">Modifica Soglia per Nuovi Soci</h4>
		</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<form role="form" action="" method="post" id="sgp-edit-form">
								<input name="id" value="<?=$soglia_nuovi_soci['id']?>" hidden="true">
								<div class="form-group">
									<label>Nuovi iscritti fino a:</label>
									<div class='input-group'>
										<input class="form-control" type="number" name="soglia_nuovi_soci" value="<?=$soglia_nuovi_soci['soglia_nuovi_soci']?>" autofocus>
...
<script>
	var url_submit_form_function = '<?=base_url()?>parametripalestra/editSogliaNuoviSoci';
