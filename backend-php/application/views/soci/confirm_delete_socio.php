<div class="modal-dialog">
	...
	<div class="modal-content">
		...
		<div class="modal-body text-center">
			<p>Vuoi davvero eliminare il socio <strong><?=$nome?> <?=$cognome?></strong> dal sistema?</p>
...
<script>
	var url_delete = '<?=base_url()?>sociocontroller/deleteSocio';
	var id = '<?=$id_socio?>';
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#modal').on('hidden.bs.modal', function () {
					//location.reload();
					var page_redirect = '<?=base_url()?>listasoci';
