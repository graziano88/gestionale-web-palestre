...
<script>
	...
	var url_edit_palestra_function = '<?=base_url()?>Palestracontroller/modificaPalestraLite';//test';//
	var url_redirect = '<?=base_url()?>listapalestre/showInfoPalestra/'+id_palestra;
