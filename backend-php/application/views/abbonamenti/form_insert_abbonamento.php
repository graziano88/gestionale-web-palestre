<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-7">
			<form role="form" action="<?=base_url()?>abbonamentocontroller/insertAbbonamento" method="post" id="sgp-insert-form">
				...
				<div class="form-group">
					...
					<div class='input-group date' id='data-fine'>
						<input type='text' class="form-control" placeholder="gg/mm/aaaa" name="data_fine" disabled/>
						<span class="input-group-addon">
							<span class="glyphicon glyphicon-calendar">
							</span>
						</span>
				...
				<div class="form-group">
					...
					<input class="form-control" name="valore_abbonamento">
				</div>
				<div class="form-group">
					<label>Durata abbonamento (giorni)</label>
					<input class="form-control" name="durata_abbonamento" disabled>
					<!-- LA DURATA NON SERVE ALLA TABELLA -->
					<!--<input name="durata_abbonamento" hidden="true">-->
				</div>
				<div class="form-group">
					<label>Attivo</label>
					<div class="radio">
						<label>
							<input type="radio" name="attivo" value="1" checked>Sì
						</label>
					</div>
					<div class="radio">
						<label>
...
<script>
	var url_submit_form_function = '<?=base_url()?>abbonamentocontroller/insertAbbonamento';
